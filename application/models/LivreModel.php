...
class LivreModel extends CI_Model {
    ...
    function get_all_livres($start =null,$pagination) {
        if($pagination==true){
            $debutLimit=$start*10;
            return $this->db->get('livre',10,  $debutLimit)->result_array();
        }
    ...
    function get_nombres_livres(){
        return $this->db->count_all_results('livre');
